    ...
    >
      <LandingContainer>
        <div className="flex items-center justify-between">
          <Link href="#inicio" onClick={(event) => scrollToSection(event, "#inicio")} className="flex items-center gap-2">
            <NextImage
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Button asChild className="bg-emerald-600 hover:bg-emerald-700 text-white">
              <Link href={routes.onboardingAcademy}>Começar agora</Link>
            </Button>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 rounded-2xl border border-zinc-800/80 bg-zinc-900/95 px-3 pb-4 pt-4 shadow-2xl backdrop-blur-xl animate-in slide-in-from-top-2 duration-200">
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-col gap-2 mt-4 pt-4 border-t border-zinc-700/50">
                <Button asChild variant="ghost" className="text-zinc-300 hover:text-white hover:bg-white/10 justify-start">
                  <Link href={routes.login}>Entrar</Link>
                </Button>
                <Button asChild className="bg-emerald-600 hover:bg-emerald-700 text-white">
                  <Link href={routes.onboardingAcademy}>Começar agora</Link>
            ...
            <div className="space-y-3 sm:space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <Card className="p-2 sm:p-3">
                  <p className="text-[8px] sm:text-[9px] text-muted-foreground">Receita do mês</p>
                  <p className="text-lg sm:text-xl font-bold">R$ 18.5k</p>
                </Card>
              </div>
              <div className="space-y-1.5 sm:space-y-2">
                <div className="p-2 rounded-lg bg-muted/50">
                  <p className="text-[9px] sm:text-[10px] font-medium">Cobranças automáticas</p>
                  <p className="text-[8px] sm:text-[9px] text-muted-foreground">Mensalidades rodando sem você precisar cobrar.</p>
                </div>
                <div className="p-2 rounded-lg bg-muted/50">
            ...
            <div className="space-y-3 sm:space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="flex gap-2">
                <div className="flex-1 p-2 rounded-lg bg-muted/50 text-center">
                  ...
                  <p className="text-[8px] sm:text-[9px] text-muted-foreground">Presenças</p>
                </div>
                <div className="flex-1 p-2 rounded-lg bg-muted/50 text-center">
                ...
                <div className="flex-1 p-2 rounded-lg bg-muted/50 text-center">
                  ...
                  <p className="text-[8px] sm:text-[9px] text-muted-foreground">Títulos</p>
                </div>
              </div>
            </div>
          )}
        ...
        {tabs.map((_, index) => (
          <button
            ...
            className={cn(
              ...
              activeTab === index ? "bg-primary w-5 sm:w-6" : "bg-muted-foreground/30"
            )}
          />
        ))}
      </div>
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section id="inicio" className="relative min-h-screen flex items-center pt-20">
        ...
        <LandingContainer className="relative z-10 py-16 sm:py-20">
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] lg:gap-14 xl:gap-16">
            <div className="space-y-6 sm:space-y-8">
              ...
              <AnimatedSection delay={200}>
                <p className="text-base sm:text-lg text-zinc-400 max-w-xl text-pretty">
                  Você não abriu sua academia para ficar cobrando mensalidade, organizando planilha e respondendo mensagem o dia inteiro. É hora de colocar a operação em ordem.
                </p>
              </AnimatedSection>
              ...
              <AnimatedSection delay={300}>
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  ...
                  <Button asChild size="lg" variant="outline" className="border-zinc-700 text-zinc-300 hover:bg-zinc-800 w-full sm:w-auto">
                  <Link href={routes.ranking}>Ver como funciona</Link>
                  </Button>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={400}>
                <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-6 text-xs sm:text-sm text-zinc-500">
                  <div className="flex items-center gap-2">
                    ...
                    <span>Site + App + Gestão + Marketing</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="h-4 w-4 text-emerald-500 shrink-0" />
      ...
      <section id="problema" className="py-16 sm:py-24 bg-[#121318]">
        <LandingContainer>
          <AnimatedSection>
            <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-balance text-white">
                Enquanto você ensina no tatame, o resto do negócio fica travado
              </h2>
              <p className="text-base sm:text-lg text-zinc-400">
                Mas hoje... é isso que mais consome seu tempo.
              </p>
            </div>
          </AnimatedSection>
            ...
            {[
              {
                ...
                description: "Você fica correndo atrás de pagamento em vez de focar no que importa.",
                color: "bg-[#3b1719]",
                iconWrap: "bg-[#2a0f12]",
              ...
              },
              {
                ...
                description: "Interessados chegam e você perde a oportunidade por não responder rápido.",
                color: "bg-[#472317]",
                iconWrap: "bg-[#30170f]",
              ...
              },
              {
                ...
                description: "Sem tempo para criar conteúdo, suas redes ficam abandonadas.",
                color: "bg-[#41152e]",
                iconWrap: "bg-[#2b0f1f]",
              ...
              {
                icon: AlertCircle,
                title: "Organização vira improviso",
                description: "Planilhas espalhadas, informações perdidas, tudo no achismo.",
                color: "bg-[#4a2c16]",
                iconWrap: "bg-[#331e0f]",
              ...
              <AnimatedSection key={item.title} delay={index * 100}>
                <Card className={cn("p-4 sm:p-6 h-full border-0", item.color)}>
                  <div className="mb-2 flex items-center gap-3 sm:mb-4 sm:gap-4">
                    <div className={cn("h-10 w-10 sm:h-12 sm:w-12 rounded-lg flex items-center justify-center shrink-0", item.iconWrap)}>
                      <item.icon className={cn("h-5 w-5 sm:h-6 sm:w-6", item.iconColor)} />
                    </div>
                    <h3 className="font-semibold text-base sm:text-base text-zinc-100">{item.title}</h3>
                  </div>
                  <p className="text-sm leading-5 sm:text-sm text-zinc-400">{item.description}</p>
                </Card>
              </AnimatedSection>
            ))}
          </div>
          ...
          <AnimatedSection delay={500}>
            <p className="text-center text-base sm:text-lg font-medium text-zinc-400 mt-8 sm:mt-12">
              E o pior: <span className="text-white">você sabe que poderia estar maior.</span>
            </p>
          </AnimatedSection>
        </LandingContainer>
      </section>
      ...
      <section id="solucao" className="py-16 sm:py-24 bg-zinc-900 text-white">
        <LandingContainer>
          <AnimatedSection>
            <div className="max-w-3xl mx-auto text-center mb-10 sm:mb-16">
              <p className="text-xs sm:text-sm font-semibold text-emerald-400 uppercase tracking-wider mb-3 sm:mb-4">A solução</p>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-balance">
                Transforme sua academia em um negócio estruturado, automatizado e escalável
              </h2>
              <p className="text-base sm:text-lg text-zinc-400">
                Com a nossa plataforma, você cria em minutos tudo que precisa para profissionalizar sua academia.
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { icon: Globe, title: "Seu site profissional" },
              { icon: Smartphone, title: "Seu aplicativo com sua marca" },
              { icon: Layout, title: "Seu sistema completo de gestão" },
              { icon: Sparkles, title: "Seu marketing automático" },
            ].map((item, index) => (
              <AnimatedSection key={item.title} delay={index * 100}>
      ...
      <section className="py-16 sm:py-24 bg-[#0a0b0f]">
        <LandingContainer>
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-16 xl:gap-20">
            <AnimatedSection>
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-emerald-950/50 flex items-center justify-center shrink-0">
                    <Globe className="h-5 w-5 sm:h-6 sm:w-6 text-emerald-600" />
                  </div>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-balance text-white">
                    Seu site que realmente traz alunos
                  </h2>
                </div>
                <p className="text-base sm:text-lg text-zinc-400">
                  Pare de depender só do Instagram. Tenha um canal próprio que trabalha por você todos os dias.
                </p>
                <ul className="space-y-3 sm:space-y-4">
                  {[
                    "Site profissional com sua identidade",
                    "Página de modalidades, horários e equipe",
                    "Captação automática de interessados",
            ...
            <AnimatedSection delay={200}>
              <Card className="border-0 bg-gradient-to-br from-emerald-950/30 to-emerald-900/15 p-4 sm:p-6 md:p-8">
                <div className="mx-auto w-full max-w-[660px] rounded-xl bg-zinc-800 shadow-2xl overflow-hidden">
                  ...
                  <div className="bg-zinc-900">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6">
                        <div className="text-center space-y-2 sm:space-y-3">
                          ...
                          <div className="flex justify-center gap-2 pt-1 sm:pt-2">
                            <span className="px-3 sm:px-4 py-1 sm:py-1.5 bg-emerald-600 text-white text-[9px] sm:text-[10px] md:text-xs rounded-full font-medium">
                              AGENDE SUA AULA
                            </span>
                          </div>
                        </div>
                    ...
                    <div className="flex justify-center gap-2 sm:gap-4 md:gap-6 py-2 sm:py-3 bg-zinc-800/50 text-[9px] sm:text-[11px] md:text-xs text-zinc-400">
                      <span className="text-emerald-400">Início</span>
                    ...
                    <div className="p-3 sm:p-4 md:p-5 space-y-3 sm:space-y-4">
                      <div className="grid grid-cols-3 gap-2 sm:gap-3">
                        {[
                          ...
                          <div key={item.label} className="text-center p-2 sm:p-3 bg-zinc-800 rounded-lg">
                            <p className="text-emerald-400 font-bold text-base sm:text-lg md:text-xl">{item.value}</p>
                            <p className="text-[8px] sm:text-[10px] md:text-xs text-zinc-500">{item.label}</p>
                          </div>
                        ))}
                      </div>
      ...
      <section className="py-16 sm:py-24 bg-[#1a1b21]">
        <LandingContainer>
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-16 xl:gap-20">
            <AnimatedSection delay={200} className="order-2 lg:order-1">
              <Card className="p-4 sm:p-6 md:p-8 bg-gradient-to-br from-amber-950/20 to-amber-900/10 border-0">
                <div className="flex justify-center">
                    ...
                    <div className="pt-7 sm:pt-8 md:pt-9 bg-gradient-to-b from-zinc-800 to-zinc-900">
                      ...
                      <div className="mx-4 sm:mx-5 mt-2 sm:mt-3 p-3 sm:p-4 rounded-2xl bg-gradient-to-r from-amber-600 to-amber-500">
                        <div className="flex items-center gap-3 sm:gap-4">
                          ...
                          <div className="text-right shrink-0">
                            ...
                            <p className="text-amber-100 text-[8px] sm:text-[10px]">presenças</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-2 sm:gap-3 px-4 sm:px-5 mt-4 sm:mt-5">
                        <div className="text-center p-2 sm:p-3 bg-zinc-800 rounded-xl">
                          ...
                          <p className="text-[8px] sm:text-[10px] text-zinc-400">Próxima aula</p>
                        ...
                        <div className="text-center p-2 sm:p-3 bg-zinc-800 rounded-xl">
                          ...
                          <p className="text-[8px] sm:text-[10px] text-zinc-400">Graduação</p>
                      ...
                      <div className="flex justify-around py-3 sm:py-4 bg-zinc-800 border-t border-zinc-700">
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-[8px] sm:text-[10px] text-amber-400 mt-1">Início</span>
                        </div>
                        <div className="flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-[8px] sm:text-[10px] text-zinc-500 mt-1">Graduação</span>
                        </div>
                        <div className="flex flex-col items-center">
            ...
            <AnimatedSection className="order-1 lg:order-2">
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-amber-950/40 flex items-center justify-center shrink-0">
                ...
                <p className="text-base sm:text-lg text-zinc-400">
                  Sua academia deixa de ser "mais uma" e vira uma marca. Experiência profissional que aumenta retenção.
                </p>
                <ul className="space-y-3 sm:space-y-4">
                  {[
                    "App com sua logo",
                    "Área do aluno completa",
                    "Presença, graduações e planos",
                    "Comunicação direta",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-2 sm:gap-3">
      ...
      <section className="py-16 sm:py-24 bg-[#0a0b0f]">
        <LandingContainer>
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:gap-16 xl:gap-20">
            <AnimatedSection>
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-sky-950/40 flex items-center justify-center shrink-0">
                    <CreditCard className="h-5 w-5 sm:h-6 sm:w-6 text-sky-600" />
                  </div>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-balance text-white">
                    Cobrança automática e controle financeiro total
                  </h2>
                </div>
                <p className="text-base sm:text-lg text-zinc-400">
                  Chega de correr atrás de pagamento. Mais previsibilidade, menos dor de cabeça.
                </p>
                <ul className="space-y-3 sm:space-y-4">
                  {[
            ...
            <AnimatedSection delay={200}>
              <Card className="p-4 sm:p-6 bg-[#0d1520] border-0">
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-[#2c2c30] rounded-lg shadow">
                    <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                      <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-emerald-100/15 flex items-center justify-center shrink-0">
                        <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-600" />
                      </div>
                      <div className="min-w-0">
                        <p className="font-medium text-xs sm:text-sm truncate text-zinc-100">Mensalidade Jiu Jitsu</p>
                        <p className="text-[10px] sm:text-xs text-zinc-400">Pago automaticamente</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-[#2c2c30] rounded-lg shadow">
                    <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="font-medium text-xs sm:text-sm truncate text-zinc-100">Mensalidade Muay Thai</p>
                        <p className="text-[10px] sm:text-xs text-zinc-400">Pago automaticamente</p>
                      </div>
                    </div>
                  ...
                  <div className="p-3 sm:p-4 bg-sky-600 text-white rounded-lg">
                    <p className="text-[10px] sm:text-xs opacity-80">Total recebido este mês</p>
      ...
      <section id="funcionalidades" className="py-16 sm:py-24 bg-[#1a1b21]">
        <LandingContainer>
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
              <p className="text-xs sm:text-sm font-semibold text-emerald-600 uppercase tracking-wider mb-3 sm:mb-4">Tudo que você precisa</p>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-white">
                Um sistema completo para sua academia
              </h2>
              <p className="text-base sm:text-lg text-zinc-400">
                Gestão de alunos, graduações, eventos e muito mais.
              </p>
            </div>
          </AnimatedSection>
            ...
            {[
              {
                ...
                description: "Cadastro completo, controle de presença, histórico individual, gestão por turmas.",
              },
              {
                icon: Award,
                title: "Sistema de graduação",
                description: "Registro de faixas, histórico de evolução, organização por nível. Mais engajamento e retenção.",
              },
              {
                icon: Calendar,
                title: "Eventos e seminários",
                description: "Crie eventos com facilidade, gerencie inscrições, divulgue para alunos. Mais faturamento.",
              },
              {
                icon: BarChart3,
                title: "CRM de leads",
                description: "Leads captados direto do site, organização automática. Quem demonstrou interesse não se perde.",
              },
              {
                icon: GraduationCap,
                title: "App do professor",
                description: "Agenda do dia, lista de alunos, chamada digital. Tudo na mão de quem ensina.",
              },
              {
                icon: Trophy,
                title: "Ranking e títulos",
                description: "Acompanhe competições, registre títulos, valorize seus atletas.",
              },
            ].map((item, index) => (
              <AnimatedSection key={item.title} delay={index * 100}>
                <Card className="p-4 sm:p-6 h-full hover:shadow-lg transition-shadow bg-[#0e1116] border-zinc-800">
                  <div className="mb-2 flex items-center gap-3 sm:mb-4 sm:gap-4">
                    <item.icon className="h-7 w-7 sm:h-8 sm:w-8 shrink-0 text-emerald-600" />
                    <h3 className="font-semibold text-base sm:text-base text-zinc-100">{item.title}</h3>
                  </div>
                  <p className="text-sm leading-5 sm:text-sm text-zinc-400">{item.description}</p>
                </Card>
      ...
      <section id="marketing" className="py-16 sm:py-24 bg-gradient-to-br from-zinc-900 via-zinc-800 to-emerald-950 text-white">
        <LandingContainer>
          <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.94fr)_minmax(0,1.06fr)] lg:gap-16 xl:gap-20">
            <AnimatedSection>
              <div className="space-y-4 sm:space-y-6">
                ...
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-balance">
                  Marketing automático com Inteligência Artificial
                </h2>
                <p className="text-base sm:text-lg text-zinc-400">
                  Aqui está o diferencial que muda o jogo. Sua academia passa a ter um time de marketing rodando sozinho.
                </p>
                <ul className="space-y-3 sm:space-y-4">
                  {[
                    "Artes prontas para redes sociais",
                    "Legendas persuasivas",
                    "Conteúdos personalizados com sua marca",
                ...
                <p className="text-xs sm:text-sm text-emerald-400 font-medium">
                  Em minutos, você cria semanas de conteúdo.
                </p>
              </div>
            </AnimatedSection>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] sm:text-xs text-zinc-400">Criando conteúdo para sua academia...</p>
                    </div>
                  </div>
                  ...
                  <div className="p-2 sm:p-3 bg-zinc-700/50 rounded-lg">
                    ...
                    <p className="text-xs sm:text-sm text-zinc-200">"O tatame é onde você descobre do que é feito. Venha treinar com a gente!"</p>
                  </div>
                  <div className="flex gap-2">
          ...
          <AnimatedSection delay={400}>
            <Card className="mt-10 sm:mt-16 p-4 sm:p-8 bg-zinc-800/50 border-zinc-700 text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2">Como se você tivesse um social media 24h trabalhando pra você</h3>
              <p className="text-sm sm:text-base text-zinc-400 max-w-2xl mx-auto">
                O sistema entende sua academia e cria conteúdos baseados em seu público, seu estilo e o que mais atrai alunos. Você foca no tatame. O marketing roda sozinho.
              </p>
            </Card>
          </AnimatedSection>
        </LandingContainer>
      ...
      <section className="py-16 sm:py-24 bg-[#05060a]">
        <LandingContainer>
          <AnimatedSection>
            <div className="text-center mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-white">
                O que acontece quando você usa tudo isso junto?
              </h2>
              <p className="text-base sm:text-lg text-zinc-400">
                Você sai do improviso e entra no controle.
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
            {[
              { value: 95, suffix: "%", label: "Redução no tempo administrativo", color: "text-emerald-600" },
              { value: 40, suffix: "%", label: "Aumento na retenção de alunos", color: "text-sky-600" },
              { value: 3, suffix: "x", label: "Mais leads convertidos", color: "text-amber-600" },
              { value: 100, suffix: "%", label: "Controle sobre a operação", color: "text-emerald-600" },
            ].map((item, index) => (
              <AnimatedSection key={item.label} delay={index * 100}>
                <Card className="p-4 sm:p-6 text-center h-full bg-[#0d1015] border-zinc-800">
          ...
          <AnimatedSection delay={500}>
            <div className="mt-10 sm:mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              {[
                ...
                <div key={item} className="flex items-center gap-2 sm:gap-3 p-3 sm:p-4 bg-emerald-950/25 rounded-lg">
                  <CheckCircle2 className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-600 shrink-0" />
                  <span className="text-xs sm:text-sm font-medium text-zinc-100">{item}</span>
                </div>
              ))}
            </div>
            <p className="text-center text-sm sm:text-base font-medium text-zinc-400 mt-6 sm:mt-8">
              Sua academia vira um <span className="text-zinc-100">negócio profissional de verdade.</span>
            </p>
          </AnimatedSection>
        </LandingContainer>
      </section>

      <section id="para-quem" className="py-16 sm:py-24 bg-[#1a1b21]">
        <LandingContainer>
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
              <p className="text-xs sm:text-sm font-semibold text-amber-600 uppercase tracking-wider mb-3 sm:mb-4">Para quem é</p>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-white">
                Feito para a realidade das academias de luta
              </h2>
              <p className="text-base sm:text-lg text-zinc-400">
                Não é um sistema genérico. Foi pensado especificamente para quem vive o dia a dia do tatame.
              </p>
            </div>
          </AnimatedSection>
            ...
            {[
              {
                ...
                description: "Comece já com estrutura profissional desde o primeiro aluno.",
              },
              {
                icon: TrendingUp,
                title: "Academias em expansão",
                description: "Escale sua operação sem perder o controle do negócio.",
              },
              {
                icon: Trophy,
                title: "Equipes competitivas",
                description: "Gerencie atletas, títulos e prepare sua equipe para crescer.",
              },
            ].map((item, index) => (
              <AnimatedSection key={item.title} delay={index * 100}>
                <Card className="p-4 sm:p-6 h-full text-center bg-[#0d1015] border-zinc-800">
                  <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-full bg-amber-950/35 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                    <item.icon className="h-6 w-6 sm:h-7 sm:w-7 text-amber-600" />
                  </div>
                  <h3 className="font-semibold text-base sm:text-base mb-1 sm:mb-2 text-zinc-100">{item.title}</h3>
                  <p className="text-sm leading-5 sm:text-sm text-zinc-400">{item.description}</p>
                </Card>
              </AnimatedSection>
            ))}
          ...
          <AnimatedSection>
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-base sm:text-lg md:text-xl text-emerald-100 mb-6 sm:mb-8 max-w-2xl mx-auto">
                Site + App + Gestão + Marketing automático. Sem complicação. Sem precisar de equipe técnica. Sem dor de cabeça.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                <Button asChild size="lg" className="bg-white text-emerald-700 hover:bg-emerald-50 w-full sm:w-auto text-sm sm:text-base">
                  <Link href={routes.onboardingAcademy}>
                    Começar agora
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-white/50 text-white hover:bg-white/10 w-full sm:w-auto text-sm sm:text-base">
