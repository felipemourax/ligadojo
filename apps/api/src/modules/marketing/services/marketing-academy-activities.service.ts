...
import type { MarketingAcademyActivity } from "@/apps/api/src/modules/marketing/domain/marketing"
...
export class MarketingAcademyActivitiesService {
  constructor(private readonly modalityRepository = new ModalityRepository()) {}

  async listForTenant(tenantId: string): Promise<MarketingAcademyActivity[]> {
